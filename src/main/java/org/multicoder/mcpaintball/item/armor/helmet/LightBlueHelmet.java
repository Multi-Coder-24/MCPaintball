...
public class LightBlueHelmet extends ArmorItem
{

    public LightBlueHelmet()
    {
        super(PaintballArmor.Light_Blue, EquipmentSlot.HEAD, new Properties().tab(tabinit.Armor));
    }
