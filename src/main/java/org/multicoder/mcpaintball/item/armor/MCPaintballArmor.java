...
public class MCPaintballArmor
{
    ...
    public static final DeferredHolder<Item,Item> LIGHT_BLUE_BOOTS = ARMORS.register("armor.light_blue_boots",() -> new PaintballBoots(MCPaintballArmorMaterial.LIME));
    public static final DeferredHolder<Item,Item> LIME_BOOTS = ARMORS.register("armor.lime_boots",() -> new PaintballBoots(MCPaintballArmorMaterial.LIGHT_BLUE));
    ...
    public static final DeferredHolder<Item,Item> LIGHT_BLUE_LEGGINGS = ARMORS.register("armor.light_blue_leggings",() -> new PaintballLeggings(MCPaintballArmorMaterial.LIME));
    public static final DeferredHolder<Item,Item> LIME_LEGGINGS = ARMORS.register("armor.lime_leggings",() -> new PaintballLeggings(MCPaintballArmorMaterial.LIGHT_BLUE));
    ...
    public static final DeferredHolder<Item,Item> LIGHT_BLUE_CHESTPLATE = ARMORS.register("armor.light_blue_chestplate",() -> new PaintballChestplate(MCPaintballArmorMaterial.LIME));
    public static final DeferredHolder<Item,Item> LIME_CHESTPLATE = ARMORS.register("armor.lime_chestplate",() -> new PaintballChestplate(MCPaintballArmorMaterial.LIGHT_BLUE));
    ...
    public static final DeferredHolder<Item,Item> LIGHT_BLUE_HELMET = ARMORS.register("armor.light_blue_helmet",() -> new PaintballHelmet(MCPaintballArmorMaterial.LIME));
    public static final DeferredHolder<Item,Item> LIME_HELMET = ARMORS.register("armor.lime_helmet",() -> new PaintballHelmet(MCPaintballArmorMaterial.LIGHT_BLUE));
