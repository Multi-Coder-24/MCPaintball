...
public class MagentaChestplate extends ArmorItem
{

    public MagentaChestplate()
    {
        super(PaintballArmor.Magenta, EquipmentSlot.CHEST, new Properties().tab(tabinit.Armor));
    }
