...
public class PurpleChestplate extends ArmorItem
{

    public PurpleChestplate()
    {
        super(PaintballArmor.Purple, EquipmentSlot.CHEST, new Properties().tab(tabinit.Armor));
    }
