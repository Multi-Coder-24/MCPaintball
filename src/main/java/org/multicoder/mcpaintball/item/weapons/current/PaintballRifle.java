...
public class PaintballRifle extends Item
{
    ...
    {
        super(new Properties().tab(tabinit.Weapons).durability(64));
    }
        ...
        if(!pLevel.isClientSide())
        {
            ...
            else
            {
                if(Projectile.get() != null)
                {
                    ...
                    Proj.shootFromRotation(Player,Player.getXRot(),Player.getYRot(),0f,1.5f, MCPaintballConfig.RIFLE_INACCURACY.get().floatValue());
                    ...
                    Player.getCooldowns().addCooldown(Weapon.getItem(), 10);
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced)
    {
        ...
        {
            pTooltipComponents.add(new TranslatableComponent("text.mcpaintball.rifle_spec").withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.GOLD));
        }
        else
        {
