...
public class GreenPistol extends Item
{
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand)
    {
        ...
        PersistentProjectileEntity AAE = new GreenPaintballArrowEntity(world,user);
        AAE.setProperties(user,user.getPitch(),user.getYaw(),user.getRoll(),3.0f,0.0f);
