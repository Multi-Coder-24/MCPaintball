            ...
            if(MCPaintballGameEvents.INSTANCE.MatchStarted && MCPaintballGameEvents.INSTANCE.RoundStarted){
                ...
                switch (data.Team){
                    case 1:
                        ...
                        redPaintball.shootFromRotation(player,player.getXRot(),player.getYRot(),0.0F,3.0F,0.1F);
                    ...
                    case 2:
                        ...
                        greenPaintball.shootFromRotation(player,player.getXRot(),player.getYRot(),0.0F,3.0F,0.1F);
                    ...
                    case 3:
                        ...
                        bluePaintball.shootFromRotation(player,player.getXRot(),player.getYRot(),0.0F,3.0F,0.1F);
