...
public class Networking
{
    ...
    public static void Register()
    {
        ...
        net.messageBuilder(ReloadC2SPacket.class,ID(),NetworkDirection.PLAY_TO_SERVER).decoder(ReloadC2SPacket::new).encoder(ReloadC2SPacket::toBytes).consumer(ReloadC2SPacket::handlePacket).add();
