...
{
    public static final EntityType<?> RED_PAINTBALL = Registry.register(Registries.ENTITY_TYPE,new Identifier(MCPaintball.ModID,"red_paintball"),
    ...
    public static final EntityType<?> BLUE_PAINTBALL = Registry.register(Registries.ENTITY_TYPE,new Identifier(MCPaintball.ModID,"blue_paintball"),
            FabricEntityTypeBuilder.create(SpawnGroup.MISC,
                    BluePaintballArrowEntity::new).dimensions(EntityDimensions.fixed(0.5f,0.5f)).build());

    public static final EntityType<?> GREEN_PAINTBALL = Registry.register(Registries.ENTITY_TYPE,new Identifier(MCPaintball.ModID,"green_paintball"),
            FabricEntityTypeBuilder.create(SpawnGroup.MISC,
