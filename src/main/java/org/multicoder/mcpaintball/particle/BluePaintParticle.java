...
public class BluePaintParticle extends SingleQuadParticle{

    public BluePaintParticle(ClientLevel level, double x, double y, double z, double xa, double ya, double za, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>{
        ...
        public @Nullable Particle createParticle(@NonNull SimpleParticleType simpleParticleType, @NonNull ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5, @NonNull RandomSource randomSource) {
            return new BluePaintParticle(clientLevel,v,v1,v2,v3,v4,v5,spriteSet);
        }
    }
}
