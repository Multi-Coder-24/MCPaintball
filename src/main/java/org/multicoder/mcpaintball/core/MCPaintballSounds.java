...
public class MCPaintballSounds {
    ...
    public static final Supplier<SoundEvent> SPARK = SOUNDS.register("spark",() -> SoundEvent.createFixedRangeEvent(Identifier.fromNamespaceAndPath(MCPaintball.MODID,"spark"),16f));
