...
public class MCPaintballArmorMaterials {
    private static final ResourceKey<EquipmentAsset> RED_ARMOR_MATERIALS = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(MCPaintball.MODID,"red"));
    private static final ResourceKey<EquipmentAsset> GREEN_ARMOR_MATERIALS = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(MCPaintball.MODID,"green"));
    private static final ResourceKey<EquipmentAsset> BLUE_ARMOR_MATERIALS = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(MCPaintball.MODID,"blue"));
    private static final ResourceKey<EquipmentAsset> YELLOW_ARMOR_MATERIALS = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(MCPaintball.MODID,"yellow"));
    private static final ResourceKey<EquipmentAsset> PINK_ARMOR_MATERIALS = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(MCPaintball.MODID,"pink"));
    private static final ResourceKey<EquipmentAsset> ORANGE_ARMOR_MATERIALS = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(MCPaintball.MODID,"orange"));
