...
public class MCPaintballKeybinding {
    ...
    public static final KeyMapping GIVE_KIT = KeyMappingHelper.registerKeyMapping(new KeyMapping("key.mcpaintball.give_kit", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_K,MCPAINTBALL_SETUP_CATEGORY));
