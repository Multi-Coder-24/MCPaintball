...
import org.multicoder.mcpaintball.block.GameControllerBlock;
...
public class MCPaintballBlocks {
    ...
    public static final Block GAME_CONTROLLER = register("game_controller", GameControllerBlock::new,BlockBehaviour.Properties.of());
    ...
    public static final Block PINK_CLAYMORE_BLOCK = register("explosives/pink_claymore_block", ClaymoreBlock::new,BlockBehaviour.Properties.of());
