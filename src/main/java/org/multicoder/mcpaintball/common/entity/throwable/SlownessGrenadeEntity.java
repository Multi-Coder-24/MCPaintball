...
public class SlownessGrenadeEntity extends ThrowableItemProjectile
{


    public SlownessGrenadeEntity(EntityType<?> p_37442_, Level p_37443_)
    {
        super((EntityType<? extends ThrowableItemProjectile>) p_37442_, p_37443_);
    }

    public SlownessGrenadeEntity(EntityType<?> p_37438_, LivingEntity p_37439_, Level p_37440_)
    {
    ...
    protected void onHitBlock(BlockHitResult result)
    {
        ...
        C.discard();
        Players.forEach(player -> player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,80)));
    ...
    protected Item getDefaultItem() {
        return MCPaintballItems.SLOW_GRENADE.get();
    }
}
