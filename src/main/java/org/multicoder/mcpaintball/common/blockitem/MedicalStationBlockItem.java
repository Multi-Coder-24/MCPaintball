...
public class MedicalStationBlockItem extends BlockItem {

    public MedicalStationBlockItem(Block pBlock) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("text.mcpaintball.med_station").withStyle(ChatFormatting.BOLD));
        } else {
