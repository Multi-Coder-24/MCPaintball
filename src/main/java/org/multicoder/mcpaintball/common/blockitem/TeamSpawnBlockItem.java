...
public class TeamSpawnBlockItem extends BlockItem {

    public TeamSpawnBlockItem(Block pBlock) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("text.mcpaintball.team_spawn").withStyle(ChatFormatting.BOLD));
        } else {
