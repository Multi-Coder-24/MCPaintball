...
public class MCPaintballItems {
    ...
    public static final DeferredItem<?> SOLO_BOOTS = ITEMS.register("gray_boots", () -> new PaintballBoots(PaintballArmorMaterial.GRAY));
    public static final DeferredItem<?> SOLO_LEGGINGS = ITEMS.register("gray_leggings", () -> new PaintballLeggings(PaintballArmorMaterial.GRAY));
    public static final DeferredItem<?> SOLO_CHESTPLATE = ITEMS.register("gray_chestplate", () -> new PaintballChestplate(PaintballArmorMaterial.GRAY));
    public static final DeferredItem<?> SOLO_HELMET = ITEMS.register("gray_helmet", () -> new PaintballHelmet(PaintballArmorMaterial.GRAY));
