...
public class PurpleClass {
    ...
    public static void PopulateRegistry() {
        ...
        //  Common Items
        STANDARD.add(new ItemStack(iteminit.PURPLE_BOOTS.get()));
        STANDARD.add(new ItemStack(iteminit.PURPLE_LEGGINGS.get()));
        STANDARD.add(new ItemStack(iteminit.PURPLE_CHESTPLATE.get()));
        STANDARD.add(new ItemStack(iteminit.PURPLE_HELMET.get()));
        MEDICAL.add(new ItemStack(iteminit.PURPLE_BOOTS.get()));
        MEDICAL.add(new ItemStack(iteminit.PURPLE_LEGGINGS.get()));
        MEDICAL.add(new ItemStack(iteminit.PURPLE_CHESTPLATE.get()));
        MEDICAL.add(new ItemStack(iteminit.PURPLE_HELMET.get()));
        HEAVY.add(new ItemStack(iteminit.PURPLE_BOOTS.get()));
        HEAVY.add(new ItemStack(iteminit.PURPLE_LEGGINGS.get()));
        HEAVY.add(new ItemStack(iteminit.PURPLE_CHESTPLATE.get()));
        HEAVY.add(new ItemStack(iteminit.PURPLE_HELMET.get()));
        SNIPER.add(new ItemStack(iteminit.PURPLE_BOOTS.get()));
        SNIPER.add(new ItemStack(iteminit.PURPLE_LEGGINGS.get()));
        SNIPER.add(new ItemStack(iteminit.PURPLE_CHESTPLATE.get()));
        SNIPER.add(new ItemStack(iteminit.PURPLE_HELMET.get()));
        ENGINEER.add(new ItemStack(iteminit.PURPLE_BOOTS.get()));
        ENGINEER.add(new ItemStack(iteminit.PURPLE_LEGGINGS.get()));
        ENGINEER.add(new ItemStack(iteminit.PURPLE_CHESTPLATE.get()));
        ENGINEER.add(new ItemStack(iteminit.PURPLE_HELMET.get()));
        ...
        STANDARD.add(new ItemStack(iteminit.PURPLE_REMOTE.get()));
        STANDARD.add(new ItemStack(blockinit.PURPLE_EXPLOSIVE_STATION.get(), 4));
        ...
        MEDICAL.add(new ItemStack(iteminit.PURPLE_REMOTE.get()));
        MEDICAL.add(new ItemStack(iteminit.PURPLE_MED_KIT.get(), 32));
        MEDICAL.add(new ItemStack(blockinit.PURPLE_MEDICAL_STATION.get(), 4));
        ...
        HEAVY.add(new ItemStack(iteminit.PURPLE_REMOTE.get()));
        HEAVY.add(new ItemStack(blockinit.PURPLE_EXPLOSIVE_STATION.get(), 12));
        HEAVY.add(new ItemStack(blockinit.PURPLE_EXPLOSIVE.get(), 16));
        ...
        SNIPER.add(new ItemStack(iteminit.PURPLE_REMOTE.get()));
        ...
        ENGINEER.add(new ItemStack(iteminit.PURPLE_REMOTE.get()));
        ENGINEER.add(new ItemStack(blockinit.PURPLE_MEDICAL_STATION.get(), 4));
        ENGINEER.add(new ItemStack(blockinit.AMMO_POD.get(), 2));
        ENGINEER.add(new ItemStack(blockinit.PURPLE_RESPAWN_STATION.get(), 2));
    }
    ...
    public static List<ItemStack> GetExplosives(KitType Class) {
        ...
        switch (Class) {
            ...
            case HEAVY -> {
                ...
                Stacks.add(new ItemStack(blockinit.PURPLE_EXPLOSIVE.get(), 4));
            }
        }
        return Stacks;
    }
