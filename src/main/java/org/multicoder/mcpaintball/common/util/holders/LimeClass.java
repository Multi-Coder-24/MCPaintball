...
public class LimeClass {
    ...
    public static void PopulateRegistry() {
        ...
        //  Common Items
        STANDARD.add(new ItemStack(iteminit.LIME_BOOTS.get()));
        STANDARD.add(new ItemStack(iteminit.LIME_LEGGINGS.get()));
        STANDARD.add(new ItemStack(iteminit.LIME_CHESTPLATE.get()));
        STANDARD.add(new ItemStack(iteminit.LIME_HELMET.get()));
        MEDICAL.add(new ItemStack(iteminit.LIME_BOOTS.get()));
        MEDICAL.add(new ItemStack(iteminit.LIME_LEGGINGS.get()));
        MEDICAL.add(new ItemStack(iteminit.LIME_CHESTPLATE.get()));
        MEDICAL.add(new ItemStack(iteminit.LIME_HELMET.get()));
        HEAVY.add(new ItemStack(iteminit.LIME_BOOTS.get()));
        HEAVY.add(new ItemStack(iteminit.LIME_LEGGINGS.get()));
        HEAVY.add(new ItemStack(iteminit.LIME_CHESTPLATE.get()));
        HEAVY.add(new ItemStack(iteminit.LIME_HELMET.get()));
        SNIPER.add(new ItemStack(iteminit.LIME_BOOTS.get()));
        SNIPER.add(new ItemStack(iteminit.LIME_LEGGINGS.get()));
        SNIPER.add(new ItemStack(iteminit.LIME_CHESTPLATE.get()));
        SNIPER.add(new ItemStack(iteminit.LIME_HELMET.get()));
        ENGINEER.add(new ItemStack(iteminit.LIME_BOOTS.get()));
        ENGINEER.add(new ItemStack(iteminit.LIME_LEGGINGS.get()));
        ENGINEER.add(new ItemStack(iteminit.LIME_CHESTPLATE.get()));
        ENGINEER.add(new ItemStack(iteminit.LIME_HELMET.get()));
        ...
        STANDARD.add(new ItemStack(iteminit.LIME_REMOTE.get()));
        STANDARD.add(new ItemStack(blockinit.LIME_EXPLOSIVE_STATION.get(), 4));
        ...
        MEDICAL.add(new ItemStack(iteminit.LIME_REMOTE.get()));
        MEDICAL.add(new ItemStack(iteminit.LIME_MED_KIT.get(), 32));
        MEDICAL.add(new ItemStack(blockinit.LIME_MEDICAL_STATION.get(), 4));
        ...
        HEAVY.add(new ItemStack(iteminit.LIME_REMOTE.get()));
        HEAVY.add(new ItemStack(blockinit.LIME_EXPLOSIVE_STATION.get(), 12));
        HEAVY.add(new ItemStack(blockinit.LIME_EXPLOSIVE.get(), 16));
        ...
        SNIPER.add(new ItemStack(iteminit.LIME_REMOTE.get()));
        ...
        ENGINEER.add(new ItemStack(iteminit.LIME_REMOTE.get()));
        ENGINEER.add(new ItemStack(blockinit.LIME_MEDICAL_STATION.get(), 4));
        ENGINEER.add(new ItemStack(blockinit.AMMO_POD.get(), 2));
        ENGINEER.add(new ItemStack(blockinit.LIME_RESPAWN_STATION.get(), 2));
    }
    ...
    public static List<ItemStack> GetExplosives(KitType Class) {
        ...
        switch (Class) {
            ...
            case HEAVY -> {
                ...
                Stacks.add(new ItemStack(blockinit.LIME_EXPLOSIVE.get(), 4));
            }
        }
        return Stacks;
    }
