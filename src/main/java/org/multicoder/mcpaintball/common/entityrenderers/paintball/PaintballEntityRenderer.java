...
public class PaintballEntityRenderer extends ArrowRenderer<PaintballEntity>
{
    ...
    public static final ResourceLocation G = ResourceLocation.fromNamespaceAndPath("mcpaintball","textures/entity/projectiles/paintball/green_paintball.png");
    public static final ResourceLocation B = ResourceLocation.fromNamespaceAndPath("mcpaintball","textures/entity/projectiles/paintball/blue_paintball.png");
