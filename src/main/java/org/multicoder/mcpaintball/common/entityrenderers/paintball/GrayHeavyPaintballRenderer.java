...
public class GrayHeavyPaintballRenderer extends ArrowRenderer<GrayHeavyPaintballEntity> {
    public static final ResourceLocation G = ResourceLocation.fromNamespaceAndPath("mcpaintball","textures/entity/projectiles/paintball_heavy/gray_paintball_heavy.png");
