...
public class MCPaintballDataContainers
{
    ...
    public static final DeferredHolder<DataComponentType<?>,DataComponentType<C4LocationData>> STACK = DATA_COMPONENTS.registerComponentType("c4_remote", builder -> builder.persistent(C4LocationData.CODEC));
}
