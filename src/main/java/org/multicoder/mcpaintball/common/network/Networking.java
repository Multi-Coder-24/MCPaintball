...
public class Networking {
    ...
    public static void Register()
    {
        try
        {
            ...
            net.messageBuilder(ReloadC2SPacket.class, ID(), NetworkDirection.PLAY_TO_SERVER).decoder(ReloadC2SPacket::new).encoder(ReloadC2SPacket::toBytes).consumerNetworkThread(ReloadC2SPacket::HandlePacket).add();
