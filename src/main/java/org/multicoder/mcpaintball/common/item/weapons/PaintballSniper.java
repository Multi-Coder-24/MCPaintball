...
public class PaintballSniper extends Item {

    public PaintballSniper() {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand)
    {
        try
        {
            ...
            {
                if(pPlayer.getItemInHand(pUsedHand).getDamageValue() < 6)
                {
                    MCPaintball.LOG.info("Current Damage: " + pPlayer.getItemInHand(pUsedHand).getDamageValue());
                    ...
                    Bullet.addTag("true");
                    Bullet.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(), 0f, 5f, MCPaintballConfig.RIFLE_INACCURACY.get().floatValue());
                    ...
                    MCPaintball.LOG.info("Damage: " + pPlayer.getItemInHand(pUsedHand).getDamageValue());
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("text.mcpaintball.sniper_spec").withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.GOLD));
        } else {
