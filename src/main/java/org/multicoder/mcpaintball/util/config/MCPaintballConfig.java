...
public class MCPaintballConfig
{
    ...
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> TRAINEE_TARGETS;
    ...
    static
    {
        ...
        TRAINEE_TARGETS = BUILDER.comment("Add Mobs That Can Be Used For Training").defineListAllowEmpty(List.of("targets"),() -> List.of("minecraft:cow","minecraft:chicken","minecraft:pig","dummmmmmy:target_dummy"),TESTER);
        BUILDER.pop();
