...
public class LightBlueGrenade extends ThrowableItemProjectile
{

    public LightBlueGrenade(double pX, double pY, double pZ, Level pLevel)
    {
        super((EntityType<? extends ThrowableItemProjectile>) entityinit.BLUE_GRENADE.get(), pX, pY, pZ, pLevel);
    }

    public LightBlueGrenade(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel)
    {
        super(pEntityType, pLevel);
    }

    public LightBlueGrenade(LivingEntity pShooter, Level pLevel)
    {
