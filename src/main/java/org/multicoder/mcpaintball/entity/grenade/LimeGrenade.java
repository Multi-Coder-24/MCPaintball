...
public class LimeGrenade extends ThrowableItemProjectile
{

    public LimeGrenade(double pX, double pY, double pZ, Level pLevel)
    {
        super((EntityType<? extends ThrowableItemProjectile>) entityinit.LIME_GRENADE.get(), pX, pY, pZ, pLevel);
    }

    public LimeGrenade(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel)
    {
        super(pEntityType, pLevel);
    }

    public LimeGrenade(LivingEntity pShooter, Level pLevel)
    {
        super((EntityType<? extends ThrowableItemProjectile>) entityinit.LIME_GRENADE.get(), pShooter, pLevel);
    }
