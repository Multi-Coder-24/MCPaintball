...
public class PinkGrenade extends ThrowableItemProjectile
{

    public PinkGrenade(double pX, double pY, double pZ, Level pLevel)
    {
        super(entityinit.PINK_GRENADE.get(), pX, pY, pZ, pLevel);
    }

    public PinkGrenade(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel)
    {
        super(pEntityType, pLevel);
    }

    public PinkGrenade(LivingEntity pShooter, Level pLevel)
    {
        super(entityinit.PINK_GRENADE.get(), pShooter, pLevel);
    }
