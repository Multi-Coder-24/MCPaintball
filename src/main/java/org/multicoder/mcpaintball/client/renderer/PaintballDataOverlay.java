...
public class PaintballDataOverlay implements GuiLayer {
    ...
    public void render(GuiGraphicsExtractor graphics, @NonNull DeltaTracker deltaTracker) {
        ...
        graphics.text(Minecraft.getInstance().font, Component.translatable("text.mcpaintball.type", Component.translatable(type.getSerializedName())),20,60, Color.WHITE.getRGB());
